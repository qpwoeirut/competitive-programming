//492161j.cpp created at 01/06/24 13:52:10
...
void solve(int testcase) {
    ...
    for (int i=0; i<N; ++i) {
        ans[A[i].second].first = lower_bound(B, B+N, make_pair(A[i].first, -1LL)) - B;
        ans[B[i].second].second = (upper_bound(A, A+N, make_pair(B[i].first, N)) - A) - 1;
    }
