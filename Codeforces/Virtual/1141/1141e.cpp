//1141e.cpp created at 07/22/21 20:04:51
...
void solve(int testcase) {
    ...
    const ll min_start = -low;
    const ll full_rounds = (start - min_start + round - 1) / round;
    debug(K, round, min_start, full_rounds);

    ll ans = N * full_rounds;
    K -= full_rounds * round;
