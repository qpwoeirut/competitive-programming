//santa_claus.cpp created at 10/07/23 10:02:39
...
void setIO(const string& filename = "santa_claus") {
    if (filename.size() > 0) {
...
void solve(int testcase) {
    ...
    if (N == 5) {
        dbl lo1 = (dbl)(A[0] + A[2]) / 2;
        dbl hi1 = (dbl)(A[N - 2] + A[N - 1]) / 2;
        dbl lo2 = (dbl)(A[0] + A[1]) / 2;
        dbl hi2 = (dbl)(A[N - 3] + A[N - 1]) / 2;
        dbl ans = max(hi1 - lo1, hi2 - lo2);
        cout << "Case #" << testcase << ": " << ans << '\n';
    } else {
        dbl lo = (dbl)(A[0] + A[1]) / 2;
        dbl hi = (dbl)(A[N - 2] + A[N - 1]) / 2;
        cout << "Case #" << testcase << ": " << hi - lo << '\n';
    }
