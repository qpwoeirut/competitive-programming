//dmopc21c1p4.cpp created at 09/06/21 12:47:13
...
/*
Given target uneveness for a tree, find the min cost
Extra log
Tree DP where each node has a vector of (length passed up, cost)
For each vector, iterate through each of the other vectors
*/
