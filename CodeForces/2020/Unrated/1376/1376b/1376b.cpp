...
void setIO(string num) {
	ios_base::sync_with_stdio(false);
	cin.tie(nullptr); cout.tie(nullptr);

	freopen(("mis/b" + num + ".in").c_str(), "r", stdin);
	freopen(("mis/b" + num + ".out").c_str(), "w", stdout);
}
