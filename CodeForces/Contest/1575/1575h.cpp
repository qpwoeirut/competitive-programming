//1575h.cpp created at 10/02/21 09:17:00
...
/*
dp[n][k] where n ≥ M and k ≥ 1 -> min cost to get exactly k occurences in the first n chars, where the last occurence is a suffix of that prefix

iterate through all m > n
use Z-function to quickly check if another occurence exists

solve for k=0 separately 
